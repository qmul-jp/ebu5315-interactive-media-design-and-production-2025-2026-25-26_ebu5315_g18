...
# Circle Geometry — Interactive Learning Website

An interactive educational website about **Circle Geometry**, featuring lessons, quizzes, and a draggable geometry game to help learners master circle theorems intuitively.
